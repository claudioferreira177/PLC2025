...
\section*{Processamento de Linguagens e Compiladores - Trabalho Prático}\label{processamento-de-linguagens-e-compiladores---trabalho-pruxe1tico}}
...
\section{ Introdução e Arquitetura do
...
\subsection{ Estrutura Modular e
...
\subsection{ Expressões Regulares e
...
\subsection{ Tratamento de ``Ruído'' e
...
\subsection{ Tratamento de Expressões e
...
\subsection{ Atributos Sintáticos e
...
\section{ Análise Semântica e Gestão de Contexto (src/sem.py e
...
\subsection{ Tabela de Símbolos e Gestão de
...
\subsection{ Verificação de Tipos (Type
...
\subsection{ Gestão de Memória e Contexto
...
\subsection{ Modelo de Execução baseada em
...
\subsection{ Mapeamento de Memória e
...
\subsection{ Implementação de Estruturas de
...
\subsection{ Chamadas de Subprogramas (Funções e
...
\subsection{ Strings e I/O}\label{strings-e-io}}
...
\section{ Testes e Resultados}\label{testes-e-resultados}}
...
\subsection{ Testes de Regressão (Casos de
...
\subsection{ Testes de Stress e Diagnóstico (Casos de
...
\subsection{ Análise de Resultados}\label{anuxe1lise-de-resultados}}
...
\section{ Conclusão e Dificuldades
...
\subsection{ Melhorias}\label{melhorias}}
